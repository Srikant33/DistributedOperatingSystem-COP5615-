...
let sendCmd cmd =
    ...
    printfn "After encrypt:%s" encrypt_string
...
let main argv = 
    printfn "%A" argv
    printfn "*     *     *     *     *     *     *     *     *     *     *     *     * \n " 
    printfn "Please Select one of the options: reg, send, subscribe, retweet, querying, # , @ "
    printfn "In the format of:  req,POST,user_name,pwd,target_user_name,tweet_content+hash_mentioned,at,register "
